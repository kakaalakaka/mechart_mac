...
{
	m_calendar = 0;
	//vector<CYearButtonMe*>::iterator sIter = m_yearButtons.begin();
	//for(; sIter != m_yearButtons.end(); ++sIter)
	//{
	//	delete *sIter;
	//	*sIter = 0;
	//}
	...
	//vector<CYearButtonMe*>::iterator sIterAm = m_yearButtons_am.begin();
	//for(; sIterAm != m_yearButtons_am.end(); ++sIterAm)
	//{
	//	delete *sIterAm;
	//	*sIterAm = 0;
	//}
...
void CYearDivMe::OnClick(const POINT& mp, MouseButtonsA button, int clicks, int delta)
{
	int count = (int)m_yearButtons.size();
	for (int i = 0; i < count; i++)
	{
