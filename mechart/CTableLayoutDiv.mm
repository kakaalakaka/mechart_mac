...
CColumnStyleMe::CColumnStyleMe( SizeTypeA sizeType, float width )
{
	m_sizeType = sizeType;
	m_width = width;
}
...
SizeTypeA CColumnStyleMe::GetSizeType()
{
	return m_sizeType;
}

void CColumnStyleMe::SetSizeTypeA( SizeTypeA sizeType )
{
	m_sizeType = sizeType;
}
...
CRowStyleMe::CRowStyleMe( SizeTypeA sizeType, float height )
{
	m_sizeType = sizeType;
	m_height = height;
}
...
SizeTypeA CRowStyleMe::GetSizeType()
{
	return m_sizeType;
}

void CRowStyleMe::SetSizeTypeA( SizeTypeA sizeType )
{
	m_sizeType = sizeType;
}
