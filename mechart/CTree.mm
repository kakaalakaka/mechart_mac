...
void CTreeMe::OnCellMouseDown( CGridCellMe *cell, const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
...
void CTreeMe::OnCellMouseMove( CGridCellMe *cell, const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
...
void CTreeMe::OnCellMouseUp( CGridCellMe *cell, const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
