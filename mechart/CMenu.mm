...
void CMenuMe::CallMenuItemMouseEvent(int eventID, CMenuItemMe *item, const POINT& mp, MouseButtonsA button, int clicks, int delta)
{
...
void CMenuMe::OnMenuItemClick(CMenuItemMe *item, const POINT& mp, MouseButtonsA button, int clicks, int delta)
{
...
void CMenuMe::OnMenuItemMouseMove(CMenuItemMe *item, const POINT& mp, MouseButtonsA button, int clicks, int delta)
{
	CNativeBaseMe *native = GetNative();
...
void CMenuMe::OnMouseDown(const POINT& mp, MouseButtonsA button, int clicks, int delta)
{
