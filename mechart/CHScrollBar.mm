...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CHScrollBarMe::BackButtonMouseDown( void *sender, const POINT& mp, MouseButtonsA button, int clicks, int delta, void *pInvoke )
{
...
void CHScrollBarMe::BackButtonMouseUp( void *sender, const POINT& mp, MouseButtonsA button, int clicks, int delta, void *pInvoke )
{
	CHScrollBarMe *pThis = (CHScrollBarMe*)pInvoke;
	if(pThis)
	{
...
CHScrollBarMe::~CHScrollBarMe()
{
	if (m_backButton)
	{
		...
		{
			m_backButton->UnRegisterEvent((void *)m_backButtonMouseDownEvent, EVENTID::MOUSEDOWN);
			m_backButtonMouseDownEvent = 0;
		}
		if (m_backButtonMouseUpEvent)
		{
			m_backButton->UnRegisterEvent((void *)m_backButtonMouseUpEvent, EVENTID::MOUSEUP);
...
void CHScrollBarMe::OnBackButtonMouseDown( const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
...
void CHScrollBarMe::OnBackButtonMouseUp( const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
	SetIsAdding(false);
	SetIsReducing(false);
}
...
void CHScrollBarMe::OnLoad()
{
	...
	{
		CButtonMe *backButton = GetBackButton();
		backButton->RegisterEvent((void *)m_backButtonMouseDownEvent, EVENTID::MOUSEDOWN, this);
		backButton->RegisterEvent((void *)m_backButtonMouseUpEvent, EVENTID::MOUSEUP, this);
	}
}
