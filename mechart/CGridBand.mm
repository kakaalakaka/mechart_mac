...
namespace MeLib
{
	...
	void CGridBandMe::OnMouseDown(const POINT& mp, MouseButtonsA button, int clicks, int delta)
	{
	...
	void CGridBandMe::OnMouseMove(const POINT& mp, MouseButtonsA button, int clicks, int delta)
	{
	...
	void CGridBandMe::OnMouseUp(const POINT& mp, MouseButtonsA button, int clicks, int delta)
	{
		if (m_resizeState != 0)
		{
