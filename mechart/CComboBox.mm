...
void CComboBoxMe::DropDownButtonMouseDown( void *sender, const POINT& mp, MouseButtonsA button, int clicks, int delta, void *pInvoke )
{
...
void CComboBoxMe::MenuItemClick( void *sender, CMenuItemMe *item, const POINT& mp, MouseButtonsA button, int clicks, int delta, void *pInvoke )
{
	CComboBoxMe *pThis = (CComboBoxMe *)pInvoke;
	if(pThis)
	{
...
CComboBoxMe::~CComboBoxMe()
{
	...
	if (m_dropDownMenu)
	{
		...
		{
			m_dropDownMenu->UnRegisterEvent((void*)m_menuItemClickEvent, EVENTID::MENUITEMCLICK);
...
void CComboBoxMe::OnLoad()
{
	...
	if (!m_dropDownMenu)
	{
		...
		m_dropDownMenu->RegisterEvent((void*)m_menuItemClickEvent, EVENTID::MENUITEMCLICK, this);
	}
	else
	{
		m_dropDownMenu->SetNative(GetNative());
