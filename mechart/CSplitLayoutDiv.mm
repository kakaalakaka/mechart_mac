...
CSplitLayoutDivMe::~CSplitLayoutDivMe()
{
	...
	{
		m_splitter->UnRegisterEvent((void *)m_splitterDraggingEvent, EVENTID::DRAGGING);
...
SizeTypeA CSplitLayoutDivMe::GetSplitMode()
{
	return m_splitMode;
}

void CSplitLayoutDivMe::SetSplitMode( SizeTypeA splitMode )
{
...
void CSplitLayoutDivMe::OnLoad()
{
	...
	if (!m_splitter)
	{
		...
		m_splitter->RegisterEvent((void *)m_splitterDraggingEvent, EVENTID::DRAGGING, this);
