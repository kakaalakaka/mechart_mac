...
LinkBehaviorA CLinkLabelMe::GetLinkBehavior()
{
	return m_linkBehavior;
}

void CLinkLabelMe::SetLinkBehavior( LinkBehaviorA linkBehavior )
{
...
void CLinkLabelMe::OnClick( const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
...
void CLinkLabelMe::OnMouseDown( const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
	CControlMe::OnMouseDown(mp, button, clicks, delta);
	Invalidate();
}

void CLinkLabelMe::OnMouseEnter( const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
	CControlMe::OnMouseEnter(mp, button, clicks, delta);
	Invalidate();
}

void CLinkLabelMe::OnMouseLeave( const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
	CControlMe::OnMouseLeave(mp, button, clicks, delta);
	Invalidate();
}

void CLinkLabelMe::OnMouseUp( const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
