...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CSpinMe::DownButtonMouseDown( void *sender, const POINT& mp, MouseButtonsA button, int clicks, int delta, void *pInvoke )
{
...
void CSpinMe::DownButtonMouseUp( void *sender, const POINT& mp, MouseButtonsA button, int clicks, int delta, void *pInvoke )
{
	CSpinMe *pThis = (CSpinMe *)pInvoke;
	if(pThis)
	{
...
void CSpinMe::UpButtonMouseDown( void *sender, const POINT& mp, MouseButtonsA button, int clicks, int delta, void *pInvoke )
{
	CSpinMe *pThis = (CSpinMe *)pInvoke;
	if(pThis)
	{
...
void CSpinMe::UpButtonMouseUp( void *sender, const POINT& mp, MouseButtonsA button, int clicks, int delta, void *pInvoke )
{
	CSpinMe *pThis = (CSpinMe *)pInvoke;
	if(pThis)
	{
...
CSpinMe::~CSpinMe()
{
	if (m_downButton)
	{
		...
		{
			m_downButton->UnRegisterEvent((void *)m_downButtonMouseDownEvent, EVENTID::MOUSEDOWN);
			m_downButtonMouseDownEvent = 0;
		}
		if (m_downButtonMouseUpEvent)
		{
			m_downButton->UnRegisterEvent((void *)m_downButtonMouseUpEvent, EVENTID::MOUSEUP);
	...
	if (m_upButton)
	{
		...
		{
			m_upButton->UnRegisterEvent((void *)m_upButtonMouseDownEvent, EVENTID::MOUSEDOWN);
			m_upButtonMouseDownEvent = 0;
		}
		if (m_upButtonMouseUpEvent)
		{
			m_upButton->UnRegisterEvent((void *)m_upButtonMouseUpEvent, EVENTID::MOUSEUP);
...
void CSpinMe::OnLoad()
{
	...
	if (!m_downButton)
	{
		...
		m_downButton->RegisterEvent((void *)m_downButtonMouseDownEvent, EVENTID::MOUSEDOWN, this);
		m_downButton->RegisterEvent((void *)m_downButtonMouseUpEvent, EVENTID::MOUSEUP, this);
		AddControl(m_downButton);
	}
	if (!m_upButton)
	{
		m_upButton = (CButtonMe*)host->CreateInternalControl(this, L"upbutton");
		m_upButton->RegisterEvent((void *)m_upButtonMouseDownEvent, EVENTID::MOUSEDOWN, this);
		m_upButton->RegisterEvent((void *)m_upButtonMouseUpEvent, EVENTID::MOUSEUP, this);
		AddControl(m_upButton);
	}
	Update();
}

void CSpinMe::OnMouseWheel( const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
