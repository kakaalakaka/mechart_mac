...
namespace MeLib
{
	...
	void CGridControlCellMe::OnAdd()
	{
		...
		if (m_control && grid)
		{
			...
			m_control->RegisterEvent((void *)m_mouseDownEvent, EVENTID::MOUSEDOWN, this);
			m_control->RegisterEvent((void *)m_mouseMoveEvent, EVENTID::MOUSEMOVE, this);
			m_control->RegisterEvent((void *)m_mouseUpEvent, EVENTID::MOUSEUP, this);
		}
	}
	...
	void CGridControlCellMe::OnRemove()
	{
		...
		if (m_control && grid)
		{
			m_control->UnRegisterEvent((void *)m_mouseDownEvent, EVENTID::MOUSEDOWN);
			m_control->UnRegisterEvent((void *)m_mouseMoveEvent, EVENTID::MOUSEMOVE);
			m_control->UnRegisterEvent((void *)m_mouseUpEvent, EVENTID::MOUSEUP);
			//m_control->UnRegisterEvent((void *)m_mouseWheelEvent, EVENTID::MOUSEWHEEL);
