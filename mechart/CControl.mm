...
void CControlMe::CallMouseEvents( int eventID, const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
    if (m_canRaiseEvents && m_events.find(eventID) != m_events.end())
    {
        vector<void*> *list = m_events[eventID];
...
void CControlMe::CallTouchEvents( int eventID, vector<CTouch> *touches )
{
    if (m_canRaiseEvents && m_events.find(eventID) != m_events.end())
    {
        vector<void*> *list = m_events[eventID];
...
CControlMe::CControlMe()
{
    ...
    m_enabled = true;
    m_focused = 0;
    m_font = new FONT(L"微软雅黑", 14, false, false, false);
...
CControlMe::~CControlMe()
{
    ...
    {
        //vector<void*>::iterator sIterInner = sIterInvokes->second->begin();
        //for(; sIterInner !=  sIterEvents->second->end(); ++sIterInner)
        //{
        //    if(*sIterInner)
        //    {
...
HorizontalAlignA CControlMe::GetAlign()
{
    return m_align;
}

void CControlMe::SetAlign( HorizontalAlignA align )
{
    m_align = align;
}
...
CursorsA CControlMe::GetCursor()
{
    return m_cursor;
}

void CControlMe::SetCursor( CursorsA cursor )
{
    m_cursor = cursor;
}
...
DockStyleA CControlMe::GetDock()
{
    return m_dock;
}

void CControlMe::SetDock( DockStyleA dock )
{
    if (m_dock != dock)
    {
        m_dock = dock;
...
VerticalAlignA CControlMe::GetVerticalAlign()
{
    return m_verticalAlign;
}

void CControlMe::SetVerticalAlign( VerticalAlignA verticalAlign )
{
...
vector<String> CControlMe::GetPropertyNames()
{
    ...
    propertyNames.push_back(L"Align");
    propertyNames.push_back(L"AllowDrag");
    propertyNames.push_back(L"AllowPreviewsEvent");
    propertyNames.push_back(L"Anchor");
    propertyNames.push_back(L"AutoEllipsis");
    propertyNames.push_back(L"AutoSize");
    propertyNames.push_back(L"BackColor");
    propertyNames.push_back(L"BackImage");
    propertyNames.push_back(L"BorderColor");
    propertyNames.push_back(L"Bounds");
    propertyNames.push_back(L"CanFocus");
    propertyNames.push_back(L"CanRaiseEvents");
    propertyNames.push_back(L"Cursor");
    propertyNames.push_back(L"DisplayOffset");
    propertyNames.push_back(L"Dock");
    propertyNames.push_back(L"Enabled");
    propertyNames.push_back(L"Focused");
    propertyNames.push_back(L"Font");
    propertyNames.push_back(L"ForeColor");
    propertyNames.push_back(L"HasPopupMenu");
    propertyNames.push_back(L"Height");
    propertyNames.push_back(L"IsWindow");
    propertyNames.push_back(L"Left");
    propertyNames.push_back(L"Location");
    propertyNames.push_back(L"Margin");
    propertyNames.push_back(L"MaximumSize");
    propertyNames.push_back(L"MinimumSize");
    propertyNames.push_back(L"Name");
    propertyNames.push_back(L"Opacity");
    propertyNames.push_back(L"Padding");
    propertyNames.push_back(L"Region");
    propertyNames.push_back(L"Padding");
    propertyNames.push_back(L"ResourcePath");
    propertyNames.push_back(L"Size");
    propertyNames.push_back(L"TabIndex");
    propertyNames.push_back(L"TabStop");
    propertyNames.push_back(L"Text");
    propertyNames.push_back(L"Top");
    propertyNames.push_back(L"TopMost");
    propertyNames.push_back(L"Vertical-Align");
...
void CControlMe::OnClick( const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
...
void CControlMe::OnDoubleClick( const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
...
void CControlMe::OnMouseDown( const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
    CallMouseEvents(EVENTID::MOUSEDOWN, mp, button, clicks, delta);
}

void CControlMe::OnMouseEnter( const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
    CallMouseEvents(EVENTID::MOUSEENTER, mp, button, clicks, delta);
}

void CControlMe::OnMouseLeave( const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
    CallMouseEvents(EVENTID::MOUSELEAVE, mp, button, clicks, delta);
}

void CControlMe::OnMouseMove( const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
    CallMouseEvents(EVENTID::MOUSEMOVE, mp, button, clicks, delta);
}

void CControlMe::OnMouseUp( const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
    CallMouseEvents(EVENTID::MOUSEUP, mp, button, clicks, delta);
}

void CControlMe::OnMouseWheel( const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
...
bool CControlMe::OnPreviewsMouseEvent( int eventID, const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
    return false;
}
...
void CControlMe::OnTouchBegin( vector<CTouch> *touches )
{
    CallTouchEvents(EVENTID::TOUCHBEGIN, touches);
}

void CControlMe::OnTouchCancel( vector<CTouch> *touches )
{
    CallTouchEvents(EVENTID::TOUCHCANCEL, touches);
}

void CControlMe::OnTouchEnd( vector<CTouch> *touches )
{
    CallTouchEvents(EVENTID::TOUCHEND, touches);
}

void CControlMe::OnTouchMove( vector<CTouch> *touches )
{
