...
ContentAlignmentA CButtonMe::GetTextAlign()
{
	return m_textAlign;
}

void CButtonMe::SetTextAlign(ContentAlignmentA textAlign)
{
...
void CButtonMe::OnMouseDown(const POINT& mp, MouseButtonsA button, int clicks, int delta)
{
	CControlMe::OnMouseDown(mp, button, clicks, delta);
	Invalidate();
}

void CButtonMe::OnMouseEnter(const POINT& mp, MouseButtonsA button, int clicks, int delta)
{
	CControlMe::OnMouseEnter(mp, button, clicks, delta);
	Invalidate();
}

void CButtonMe::OnMouseLeave(const POINT& mp, MouseButtonsA button, int clicks, int delta)
{
	CControlMe::OnMouseLeave(mp, button, clicks, delta);
	Invalidate();
}

void CButtonMe::OnMouseUp(const POINT& mp, MouseButtonsA button, int clicks, int delta)
{
