...
CursorsA CWindowMe::GetResizeCursor( int state )
{
	switch (state)
	{
	case 0:
...
void CWindowMe::OnMouseDown( POINT mp, MouseButtonsA button, int clicks, int delta )
{
...
void CWindowMe::OnMouseMove( POINT mp, MouseButtonsA button, int clicks, int delta )
{
...
void CWindowMe::OnMouseUp( POINT mp, MouseButtonsA button, int clicks, int delta )
{
