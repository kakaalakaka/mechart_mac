...
namespace MeLib
{
	...
	HorizontalAlignA CGridColumnMe::GetCellAlign()
	{
		return m_cellAlign;
	}
	
	void CGridColumnMe::SetCellAlign(HorizontalAlignA cellAlign)
	{
	...
	void CGridColumnMe::OnClick(const POINT& mp, MouseButtonsA button, int clicks, int delta)
	{
				...
				if (column == this)
				{
					...
					if (lastColumn)
					{
						...
						if (clientX < lastClientX + (lastColumn->GetWidth() / 2))
						{
							...
							//String lastTEXT = lastColumn->GetText();
					...
					if (nextColumn)
					{
						...
						{
							//String text = this->GetText();
							//String nextTEXT = nextColumn->GetText();
							m_grid->m_columns[i + 1] = this;
	...
	void CGridColumnMe::OnMouseDown(const POINT& mp, MouseButtonsA button, int clicks, int delta)
	{
	...
	void CGridColumnMe::OnMouseMove(const POINT& mp, MouseButtonsA button, int clicks, int delta)
	{
	...
	void CGridColumnMe::OnMouseUp(const POINT& mp, MouseButtonsA button, int clicks, int delta)
	{
