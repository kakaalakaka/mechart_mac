...
vector<String> CVScaleMe::GetPropertyNames()
{
    ...
    propertyNames.push_back(L"AutoMaxMin");
    propertyNames.push_back(L"BaseField");
    propertyNames.push_back(L"Digit");
    propertyNames.push_back(L"Font");
    propertyNames.push_back(L"ForeColor");
    propertyNames.push_back(L"ForeColor2");
    propertyNames.push_back(L"Magnitude");
    propertyNames.push_back(L"MidValue");
    propertyNames.push_back(L"NumberStyle");
    propertyNames.push_back(L"PaddingBottom");
    propertyNames.push_back(L"PaddingTop");
    propertyNames.push_back(L"Reverse");
    propertyNames.push_back(L"ScaleColor");
    propertyNames.push_back(L"System");
    propertyNames.push_back(L"Type");
    propertyNames.push_back(L"VisibleMax");
    propertyNames.push_back(L"VisibleMin");
