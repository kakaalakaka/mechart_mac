...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CScrollBarMe::AddButtonMouseDown( void *sender, const POINT& mp, MouseButtonsA button, int clicks, int delta, void *pInvoke )
{
...
void CScrollBarMe::AddButtonMouseUp( void *sender, const POINT& mp, MouseButtonsA button, int clicks, int delta, void *pInvoke )
{
	CScrollBarMe *pThis = (CScrollBarMe*)pInvoke;
	if(pThis)
	{
...
void CScrollBarMe::ReduceButtonMouseDown( void *sender, const POINT& mp, MouseButtonsA button, int clicks, int delta, void *pInvoke )
{
	CScrollBarMe *pThis = (CScrollBarMe*)pInvoke;
	if(pThis)
	{
...
void CScrollBarMe::ReduceButtonMouseUp( void *sender, const POINT& mp, MouseButtonsA button, int clicks, int delta, void *pInvoke )
{
	CScrollBarMe *pThis = (CScrollBarMe*)pInvoke;
	if(pThis)
	{
...
CScrollBarMe::~CScrollBarMe()
{
	...
	if (m_addButton)
	{
		...
		{
			m_addButton->UnRegisterEvent((void *)m_addButtonMouseDownEvent, EVENTID::MOUSEDOWN);
			m_addButtonMouseDownEvent = 0;
		}
		if (m_addButtonMouseUpEvent)
		{
			m_addButton->UnRegisterEvent((void *)m_addButtonMouseUpEvent, EVENTID::MOUSEUP);
			m_addButtonMouseUpEvent = 0;
		}
	}
	if (m_scrollButton && m_scrollButtonDraggingEvent)
	{
		m_scrollButton->UnRegisterEvent((void *)m_scrollButtonDraggingEvent, EVENTID::DRAGGING);
	...
	if (m_reduceButton)
	{
		...
		{
			m_reduceButton->UnRegisterEvent((void *)m_reduceButtonMouseDownEvent, EVENTID::MOUSEDOWN);
			m_reduceButtonMouseDownEvent = 0;
		}
		if (m_reduceButtonMouseUpEvent)
		{
			m_reduceButton->UnRegisterEvent((void *)m_reduceButtonMouseUpEvent, EVENTID::MOUSEUP);
...
void CScrollBarMe::OnAddButtonMouseDown( const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
	LineAdd();
	SetIsAdding(true);
}

void CScrollBarMe::OnAddButtonMouseUp( const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
	SetIsAdding(false);
}
...
void CScrollBarMe::OnAddSpeedScrollStart( uint64_t startTime, uint64_t nowTime, int start, int end )
{
...
void CScrollBarMe::OnLoad()
{
	...
	if (!m_addButton)
	{
		...
		m_addButton->RegisterEvent((void *)m_addButtonMouseDownEvent, EVENTID::MOUSEDOWN, this);
		m_addButton->RegisterEvent((void *)m_addButtonMouseUpEvent, EVENTID::MOUSEUP, this);
	...
	if (!m_reduceButton)
	{
		...
		m_reduceButton->RegisterEvent((void *)m_reduceButtonMouseDownEvent, EVENTID::MOUSEDOWN, this);
		m_reduceButton->RegisterEvent((void *)m_reduceButtonMouseUpEvent, EVENTID::MOUSEUP, this);
	...
	if (!m_scrollButton)
	{
		...
		m_scrollButton->RegisterEvent((void *)m_scrollButtonDraggingEvent, EVENTID::DRAGGING, this);
		m_backButton->AddControl(m_scrollButton);
	}
}

void CScrollBarMe::OnReduceButtonMouseDown( const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
	LineReduce();
	SetIsReducing(true);
}

void CScrollBarMe::OnReduceButtonMouseUp( const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
	SetIsReducing(false);
}
