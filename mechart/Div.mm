...
void DivMe::ScrollButtonMouseWheel( void *sender, const POINT& mp, MouseButtonsA button, int clicks, int delta, void *pInvoke )
{
	DivMe *divA = (DivMe *)pInvoke;
	if(divA)
	{
...
CHScrollBarMe* DivMe::GetHScrollBar()
{
	...
	if (!m_hScrollBar)
	{
		...
		m_hScrollBar->GetAddButton()->RegisterEvent((void *)m_scrollButtonKeyDownEvent, EVENTID::KEYDOWN, this);
		m_hScrollBar->GetAddButton()->RegisterEvent((void *)m_scrollButtonMouseWheelEvent, EVENTID::MOUSEWHEEL, this);
		m_hScrollBar->GetBackButton()->RegisterEvent((void *)m_scrollButtonKeyDownEvent, EVENTID::KEYDOWN, this);
		m_hScrollBar->GetBackButton()->RegisterEvent((void *)m_scrollButtonMouseWheelEvent, EVENTID::MOUSEWHEEL, this);
		m_hScrollBar->GetReduceButton()->RegisterEvent((void *)m_scrollButtonKeyDownEvent, EVENTID::KEYDOWN, this);
		m_hScrollBar->GetReduceButton()->RegisterEvent((void *)m_scrollButtonMouseWheelEvent, EVENTID::MOUSEWHEEL, this);
		m_hScrollBar->GetScrollButton()->RegisterEvent((void *)m_scrollButtonKeyDownEvent, EVENTID::KEYDOWN, this);
		m_hScrollBar->GetScrollButton()->RegisterEvent((void *)m_scrollButtonMouseWheelEvent, EVENTID::MOUSEWHEEL, this);
	}
	return m_hScrollBar;
}
...
CVScrollBarMe* DivMe::GetVScrollBar()
{
	...
	if (!m_vScrollBar)
	{
		...
		m_vScrollBar->GetAddButton()->RegisterEvent((void *)m_scrollButtonKeyDownEvent, EVENTID::KEYDOWN, this);
		m_vScrollBar->GetAddButton()->RegisterEvent((void *)m_scrollButtonMouseWheelEvent, EVENTID::MOUSEWHEEL, this);
		m_vScrollBar->GetBackButton()->RegisterEvent((void *)m_scrollButtonKeyDownEvent, EVENTID::KEYDOWN, this);
		m_vScrollBar->GetBackButton()->RegisterEvent((void *)m_scrollButtonMouseWheelEvent, EVENTID::MOUSEWHEEL, this);
		m_vScrollBar->GetReduceButton()->RegisterEvent((void *)m_scrollButtonKeyDownEvent, EVENTID::KEYDOWN, this);
		m_vScrollBar->GetReduceButton()->RegisterEvent((void *)m_scrollButtonMouseWheelEvent, EVENTID::MOUSEWHEEL, this);
		m_vScrollBar->GetScrollButton()->RegisterEvent((void *)m_scrollButtonKeyDownEvent, EVENTID::KEYDOWN, this);
		m_vScrollBar->GetScrollButton()->RegisterEvent((void *)m_scrollButtonMouseWheelEvent, EVENTID::MOUSEWHEEL, this);
	}
	return m_vScrollBar;
}
...
void DivMe::OnMouseDown( const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
...
void DivMe::OnMouseMove( const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
...
void DivMe::OnMouseUp( const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
...
void DivMe::OnMouseWheel( const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
...
bool DivMe::OnPreviewsMouseEvent( int eventID, const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
	if (m_allowPreviewsEvent)
	{
