...
HorizontalAlignA CCheckBoxMe::GetButtonAlign()
{
	return m_buttonAlign;
}

void CCheckBoxMe::SetButtonAlign(HorizontalAlignA buttonAlign)
{
...
void CCheckBoxMe::OnClick(const POINT& mp, MouseButtonsA button, int clicks, int delta)
{
