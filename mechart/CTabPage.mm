...
void CTabPageMe::HeaderMouseDown(void *sender, const POINT& mp, MouseButtonsA button, int clicks, int delta, void *pInvoke)
{
	CTabPageMe *page = (CTabPageMe*)pInvoke;
	if(page)
	{
...
CTabPageMe::~CTabPageMe()
{
	...
	if (m_dragHeaderBeginEvent)
	{
		if (m_headerButton)
		{
			m_headerButton->UnRegisterEvent((void*)m_dragHeaderBeginEvent, EVENTID::DRAGBEGIN);
		}
	...
	if (m_dragHeaderEndEvent)
	{
		if (m_headerButton)
		{
			m_headerButton->UnRegisterEvent((void*)m_dragHeaderEndEvent, EVENTID::DRAGEND);
		}
	...
	if (m_draggingHeaderEvent)
	{
		if (m_headerButton)
		{
			m_headerButton->UnRegisterEvent((void*)m_draggingHeaderEvent, EVENTID::DRAGGING);
		}
	...
	if (m_headerMouseDownEvent)
	{
		if (m_headerButton)
		{
			m_headerButton->UnRegisterEvent((void*)m_headerMouseDownEvent, EVENTID::MOUSEDOWN);
		}
...
void CTabPageMe::OnLoad()
{
	...
	if (m_tabControl)
	{
		if (!m_headerButton)
		{
			...
			m_headerButton->RegisterEvent((void *)m_dragHeaderBeginEvent, EVENTID::DRAGBEGIN, this);
			m_headerButton->RegisterEvent((void *)m_dragHeaderEndEvent, EVENTID::DRAGEND, this);
			m_headerButton->RegisterEvent((void *)m_draggingHeaderEvent, EVENTID::DRAGGING, this);
			m_headerButton->RegisterEvent((void *)m_headerMouseDownEvent, EVENTID::MOUSEDOWN, this);
		}
