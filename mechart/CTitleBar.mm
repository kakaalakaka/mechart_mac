...
vector<String> CTitleMe::GetPropertyNames()
{
    ...
    propertyNames.push_back(L"FieldTextMode");
    propertyNames.push_back(L"FieldTextSeparator");
    propertyNames.push_back(L"TextColor");
...
vector<String> CTitleBarMe::GetPropertyNames()
{
    ...
    propertyNames.push_back(L"MaxLine");
    propertyNames.push_back(L"ShowUnderLine");
    propertyNames.push_back(L"Text");
    propertyNames.push_back(L"UnderLineColor");
    propertyNames.push_back(L"Visible");
	return propertyNames;
}
