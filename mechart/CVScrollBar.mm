...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CVScrollBarMe::BackButtonMouseDown( void *sender, const POINT& mp, MouseButtonsA button, int clicks, int delta, void *pInvoke )
{
...
void CVScrollBarMe::BackButtonMouseUp( void *sender, const POINT& mp, MouseButtonsA button, int clicks, int delta, void *pInvoke )
{
	CVScrollBarMe *pThis = (CVScrollBarMe*)sender;
	if(pThis)
	{
...
void CVScrollBarMe::OnBackButtonMouseDown( const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
...
void CVScrollBarMe::OnBackButtonMouseUp( const POINT& mp, MouseButtonsA button, int clicks, int delta )
{
	SetIsAdding(false);
	SetIsReducing(false);
}
