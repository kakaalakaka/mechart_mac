...
CMenuItemMe::CMenuItemMe()
{
    ...
    m_parentMenu = 0;
    m_text = L"";
    FONT font(L"宋体", 12, false, false, false);
    SetFont(&font);
    SIZE size = { 200, 25 };
    SetSize(size);
}
...
void CMenuItemMe::OnClick(const POINT& mp, MouseButtonsA button, int clicks, int delta)
{
...
void CMenuItemMe::OnMouseMove(const POINT& mp, MouseButtonsA button, int clicks, int delta)
{
